		...
		$href=$_POST['href'];
		$id=$_POST['id'];
		$query="INSERT INTO Page(title,image,href,id) VALUES('{$title}','{$image}','{$href}',$id)";
		...
		<div class="tab-content">
			<div class="subpvda2 tab-pane fade in active container " id="menu1">
				<form class="" method="POST">
					...
					<label class="white"><br>id: <br></label>
					<input name="id" type="text" placeholder="id" class="form-control inputsp blue">
					<br>
